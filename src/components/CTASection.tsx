	...
	return (
		<section id='waitlist-section' className='py-12 md:py-20 px-4 md:px-8 bg-muted/30'>
			<div className='max-w-4xl mx-auto text-center'>
				...
				<p className='text-lg md:text-xl text-muted-foreground mb-8 md:mb-12 max-w-2xl mx-auto px-4'>Join the waitlist and be the first to use CreateADoc.</p>
						...
						{isSignedIn ? (
							...
							<div className='waitlist-container'>
								<Waitlist
									...
									appearance={{
										elements: {
											formButtonPrimary: 'bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-sm md:text-base py-3 px-6',
