	...
	return (
		<section className='py-20 px-8 bg-background'>
			<div className='max-w-7xl mx-auto'>
				{/* Dashboard Mockup */}
				<div className='bg-gradient-to-br from-muted/50 to-muted/30 rounded-2xl p-8 shadow-2xl border'>
					<div className='grid lg:grid-cols-3 gap-8'>
						...
						<div className='lg:col-span-1 space-y-6'>
							<div className='grid grid-cols-1 gap-4'>
								<Card className='border-0 shadow-lg'>
									<CardContent className='p-6'>
										<div className='text-center'>
											...
											<p className='text-3xl font-bold text-primary'>12.3 Hours</p>
								...
								<Card className='border-0 shadow-lg'>
									<CardContent className='p-6'>
										<div className='text-center'>
											<p className='text-sm text-muted-foreground mb-1'>AI Prompts Generated</p>
							...
							<Card className='border-0 shadow-lg'>
								<CardHeader className='pb-3'>
									<CardTitle className='text-lg font-semibold'>AI Clarity Score</CardTitle>
									<p className='text-sm text-muted-foreground'>How clear are your prompts to AI tools?</p>
								</CardHeader>
								<CardContent className='space-y-4'>
						...
						<Card className='lg:col-span-1 border-0 shadow-lg'>
							<CardHeader className='pb-4'>
								<CardTitle className='text-xl font-bold text-foreground'>Download Docs</CardTitle>
							</CardHeader>
							<CardContent className='space-y-4'>
								...
								<div className='space-y-3'>
									...
									<div className='flex items-center justify-between p-3 bg-accent/10 rounded-lg border border-accent/20'>
										<span className='text-sm font-medium text-accent'>Project Structure</span>
										<span className='text-xs text-muted-foreground'>→</span>
									</div>

									<div className='flex items-center justify-between p-3 bg-accent/10 rounded-lg border border-accent/20'>
										<span className='text-sm font-medium text-accent'>Schema Design</span>
										<span className='text-xs text-muted-foreground'>→</span>
									</div>

									<div className='flex items-center justify-between p-3 bg-accent/10 rounded-lg border border-accent/20'>
										<span className='text-sm font-medium text-accent'>User Flow</span>
										<span className='text-xs text-muted-foreground'>→</span>
									</div>

									<div className='flex items-center justify-between p-3 bg-accent/10 rounded-lg border border-accent/20'>
										<span className='text-sm font-medium text-accent'>Styling</span>
										<span className='text-xs text-muted-foreground'>→</span>
									</div>
								</div>
